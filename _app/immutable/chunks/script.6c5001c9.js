import{D as g,f as b}from"./2.5f3b6209.js";import{D as k}from"./depickle.7b50937e.js";import{p as y}from"./pako.esm.29d98458.js";import{C as $}from"./Code.bab618d2.js";function v(n){const i=n.module;if(i.module!==d.RenPy)throw new Error("parseRenPyClass: This function is only for parsing RenPy module classes.");switch(i.name){case"Init":return n.state[1].block.map(a).join(`
