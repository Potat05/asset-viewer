import{D as g,f as b}from"./2.d113004e.js";import{D as k}from"./depickle.168c7187.js";import{p as y}from"./pako.esm.29d98458.js";import{C as $}from"./Code.dfa0ba47.js";function v(n){const i=n.module;if(i.module!==d.RenPy)throw new Error("parseRenPyClass: This function is only for parsing RenPy module classes.");switch(i.name){case"Init":return n.state[1].block.map(a).join(`
