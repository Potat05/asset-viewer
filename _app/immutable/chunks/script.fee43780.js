import{D as g,f as b}from"./2.1e08a865.js";import{D as k}from"./depickle.dbe49254.js";import{p as y}from"./pako.esm.29d98458.js";import{C as $}from"./Code.7af49d71.js";function v(n){const i=n.module;if(i.module!==d.RenPy)throw new Error("parseRenPyClass: This function is only for parsing RenPy module classes.");switch(i.name){case"Init":return n.state[1].block.map(a).join(`
